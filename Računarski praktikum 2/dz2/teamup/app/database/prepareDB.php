<?php
	...
	if(!($has_tables)) {
		...
		try {
			...
			$st->execute( array( 'id' => 2, 't' => 'Novi Fejsbuk', 'a' => 'U ovom projektu napravit ćemo novi Fejsbuk koji će još skupljati još više informacija o svojim korisnicima i koji će još češće i još slučajnije curiti te informacije trećim stranama.', 'no' => '5', 'st' => 'open' ) ); // ana
