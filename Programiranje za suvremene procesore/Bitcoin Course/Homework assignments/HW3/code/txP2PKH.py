...
tx_hash = '832ba48c3770eadcecba50c16b2bd93ad545bb459f9adc80491e4be8d29bfa71'
tx_index = 0
...
print(newInput)
print(newInput.value(True)) #need to put True for testnet; othewise fetch will return an error
...
newOutput = TxOut(6000,ScriptPubkey)
